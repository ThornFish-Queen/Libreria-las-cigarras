		...
		<div class="container col-md-5">
			<div class="card-body">
				<c:if test="${prestamo != null}">
					<form action="updateprestamo" method="post">
				</c:if>
				<c:if test="${prestamo == null}">
					<form action="insertprestamo" method="post">
				</c:if>
				<caption>
					<h2>
						<c:if test="${prestamo != null}">
...
INGRESAR PRESTAMO
				...
				<fieldset class="form-group">
					<label>USUARIO</label> <select class="form-control"
						...
						<c:forEach var="usuario" items="${listaUsuario}">
							<c:choose>
								<c:when test="${usuario.id == prestamo.id_usuario}">
				...
				<div class="iconos">
					<a href="<%=request.getContextPath()%>/listprestamo"> <img
						class="regresar"
