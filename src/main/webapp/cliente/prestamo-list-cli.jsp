...
if (sesion.getAttribute("nombre") != null && sesion.getAttribute("password") != null && sesion.getAttribute("id_rol").equals("2")) {
...
<body>
	...
	<div class="row">
		...
		<div class="container">
			<div class='titulo'>
				<h3 class="text-center">MIS PRESTAMOS</h3>
			</div>
			<div class="container text-left">
				<a href="<%=request.getContextPath()%>/newprestamocli" class="btn">AÑADIR</a>
			</div>
			<br>
			<table class="table">
				<thead>
				...
				<tbody>
					...
					<c:forEach var="prestamo" items="${listPrestamo}">
						<tr>
							...
							<td class='iconos'><a
								href="editprestamocli?id_prestamo=<c:out value='${prestamo.id_prestamo}' />"><img
									class="editar"
