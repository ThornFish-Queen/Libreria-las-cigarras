	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="container text-left">
				<a href="<%=request.getContextPath()%>/newusuario" class="btn">AÑADIR</a>
			</div>
			<br>
			<table class="table">
				<thead>
				...
				<tbody>
					...
					<c:forEach var="usuario" items="${listUsuario}">
						<tr>
							<td class="colum"><c:out value="${usuario.id}" /></td>
							<td><c:out value="${usuario.nombre}" /></td>
							<td><c:out value="${usuario.correo}" /></td>
							<td><c:out value="${usuario.direccion}" /></td>
							<td class="colum"><c:out value="${usuario.celular}" /></td>
							<td class="colum"><c:out value="${usuario.id_rol}" /></td>
							<td class='iconos'><a
								href="editusuario?id=<c:out value='${usuario.id}' />"><img
									class="editar"
									src="https://cdn-icons-png.flaticon.com/512/1160/1160515.png"></a>
								<a href="deleteusuario?id=<c:out value='${usuario.id}' />"><img
									class="eliminar"
